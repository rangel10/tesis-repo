...
objs_01 <- unlist(data_01[1])
biomass_01 <- unlist(data_01[2])
rxns_01 <- unlist(data_01[3])

objs_nat <- unlist(data_nat[1])
biomass_nat <- unlist(data_nat[2])
rxns_nat <- unlist(data_nat[3])

objs_07 <- unlist(data_07[1])
biomass_07 <- unlist(data_07[2])
rxns_07 <- unlist(data_07[3])
